/**
 * GönülSepet35 — ürün verisi index.html içindeki #site-veri bloğundan okunur.
 */
...
function siteVerisiAl() {
  const gomulu = document.getElementById("site-veri");
  if (!gomulu?.textContent?.trim()) return null;
...
async function urunleriYukle() {
  try {
    ...
    console.error(err);
    hataGoster(
      "Ürünler yüklenemedi. index.html içindeki site-veri bölümünü kontrol edin."
    );
  }
}
